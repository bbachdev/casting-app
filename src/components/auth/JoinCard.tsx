...
export default function SignInCard() {
  ...
  return (
    <Card className={`mx-auto w-full md:w-1/2 lg:w-1/3 flex flex-col`}>
      ...
      <CardContent>
        { currentStep === 0 && (
          <BasicInfo userInfo={userInfo} setUserInfo={setUserInfo} setCurrentStep={setCurrentStep}/>
        )}
        { currentStep === 1 && (
          <AuthInfo userInfo={userInfo} setUserInfo={setUserInfo} setCurrentStep={setCurrentStep}/>
        )}
      </CardContent>
    </Card>
  )
